...
from backend.schemas import HazardCreate, NearbyHazardsQuery
...
class HazardService:
    ...
    def verify_hazard(self, hazard_id: str) -> HazardEvent:
        hazard = self._get_hazard_or_raise(hazard_id)
    ...
    def _get_hazard_or_raise(self, hazard_id: str) -> HazardEvent:
